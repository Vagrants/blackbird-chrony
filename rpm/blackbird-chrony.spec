...
Summary: Get chrony information.
Name: %{name}
Version: %{version}
...
* Project Page: https://github.com/Vagrants/blackbird-chrony
...
cp -p chrony.cfg $RPM_BUILD_ROOT/%{blackbird_conf_dir}/chrony.cfg
...
%changelog
* Tue Jan 13 2015 makochi <makocchi@gmail.com> - 0.1.0-1
- first release
